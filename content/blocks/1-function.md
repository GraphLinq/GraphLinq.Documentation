---
title: "Function Type"
metaTitle: "GraphLinq Docs - Function Type"
metaDescription: "Describe what function type is about"
---


The function Type is the node type that perform a specific task: it execute a fixed action (set of multiple instructions)
inside your graph.


Current deployed function list over the Engine network:<br/>
