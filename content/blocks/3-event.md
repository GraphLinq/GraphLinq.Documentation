---
title: "Event Trigger Type"
metaTitle: "GraphLinq Docs - Event Type"
metaDescription: "Describe what event type is about"
---


The event Type is the node type that receive data from streams of third parties like Binance, Uniswap, Ethereum, Binance smart chain..
And internal cycle start events, such as Timer node.


Current deployed events list over the Engine network:<br/>
